...
public class dto_pedido_detalle {
	...
	public dto_pedido_detalle() {

	}

	public dto_pedido_detalle(long codigo_barra, String num_pedido, String descripcion, double cantidad, String obs,
			String seccion) {
		super();
