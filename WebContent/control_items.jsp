...
<body class="p-3 mb-2 bg-light text-dark">
	...
	<form action="controller" method="post" id="myForm2">
...
<!-- 		aria-expanded="false" aria-controls="collapseExample"> Volver </a> -->
	...
	<form action="controller" method="post" id="myForm">
		<input type="hidden" name="seleccion" value="control_items_control_cantidad_actualizar">
		...
		<div class="form-group">
			...
			<table>
				...
				<!-- VALOR OCULTO PARA ENVIAR NUM_PEDIDO AL CONTROLLER Y ASI EVITAR QUE AL VOLVER NO TENGA NUM_PEDIDO -->	
				<tr>
	...
	<script type="text/javascript">
		...
		$("#num_pedido").val("${num_pedido}"); //PARA EL VALOR OCULTO
	...
	<script type="text/javascript">
		...
		function buscar() { //BUSCAR EL ARTICULO TRAS PASAR EL ESCANER, Y ENVIAR LA INFORMACION A controller2.
			...
			location.href = "controller?seleccion=control_items_busqueda" + codigo2 + ","
