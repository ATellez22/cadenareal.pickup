...
<body class="p-3 mb-2 bg-light text-dark">
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" class="form-control" name="txt_cod2"
						size="30" id="txt_cod2" onkeydown="onKeyDownHandler(event);"></td>
	...
	<script type="text/javascript">
		...
		var codigo = document.getElementById('txt_cod2').value;
		
		
		function onKeyDownHandler(event) { //VERIFICAR LA TECLA QUE SE ESTA PRESIONANDO. SI SE TECLEA ALGO QUE ESTA BLOQUEADO, LA FUNCION NO SE EJECUTA
		    ...
		    if(codigo === 8 || codigo === 46){
		      ...
		      console.log("Tecla DEL");
		      
		    } else {
		    	
		    	$('#txt_cod2').keyup(function() {			
